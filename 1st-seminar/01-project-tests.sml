...
val test2 = rmEmpty
    ...
    Eq [True, Eq [False, Var 3, And [True, True, False, Or [Var 1,Not (Eq [Var 4,False,True])], Imp (True,Var 2)]]] handle NotImplemented => false;
...
val test3 = pushNegations (Not (Not (Not (Not (True))))) = True;
...
val test3 = rmConstants
    (Eq [Var 1, Eq [False, Var 3, And [And [], Or [Var 1, Not (Eq [Var 4, False, True])], Imp (True, Var 2)]]]) = Eq [Var 1,And [Not (Var 3),Not (Var 2)]] handle NotImplemented => false;
val test4 = rmConstants (Or [True, True, True, Var 2]) = True;
val test5 = rmConstants (And [Var 2]) = Var 2;
val test6 = rmConstants (And [True, True, True, True, True, True]) = True;
val test7 = rmConstants (And [True, True, True, True, True, False]) = False;
val test8 = rmConstants (And []) = True;
val test9 = rmConstants (And [Or [And [Or []]]]) = False;
val test10 = rmConstants (Imp (False, Var 1)) = True;
val test11 = rmConstants (Imp (Var 1, False)) = Not(Var 1);
val test12 = rmConstants (And [True, Var 1, False]) = False;
val test13 = rmConstants (Or [False, Var 1, True]) = True;
val test14 = rmConstants (And [Eq [Var 1, False, Var 2], False]) = False;
val test15 = rmConstants (And [Eq [Var 1, False, False], True]) = Not (Var 1);
val test16 = rmConstants (Eq [Var 1, Not (Var 2), True, Var 3]) = And [Var 1, Not (Var 2), Var 3];
val test17 = rmConstants (Eq [Var 1, False]) = Not (Var 1);
val test18 = rmConstants (Eq [Var 1, True]) = Var 1;
val test19 = rmConstants (Not (Not (Var "x"))) = Not (Not (Var "x"));
val _ = (all_tests := !all_tests @ [test1, test2, test3, test4, test5, test6, test7, test8, test9, test10, test11, test12, test13]);
...
val test0 = satSolver (Not (Not True) : int expression) = NONE handle InvalidCNF => true;
...
val test6a = satSolver (And [Or [Var 1, Not (Var 2)]]);
val test7a = satSolver (And [Or [Var 1, Not (Var 1)]]);
val test8a = satSolver (And [Or [Var 1, Var 3], Or [Not (Var 1), Not (Var 3)],Or[Not (Var 3), Var 1]]);
val test9a = satSolver (And [Or [Var 1, Var 3], Or [Not (Var 1), Not (Var 3)],
                        Or[Not (Var 3), Var 1], Or[Not (Var 1), Var 3]]);
val _ = (all_tests := !all_tests @ [test0, test1, test2, test3, test4, test5, test6, test6, test7, test8, test9, test10]);
